...
function get_stylesheet_directory_uri() {
	...
	if (class_exists('Modules') and $module = Modules::get($stylesheet)) {
...
function get_theme_root_uri( $stylesheet_or_template = false, $theme_root = false ) {
	...
	/** @type  $theme_root_uri 修复多语言环境下静态文件错误 */
	$theme_root_uri = strstr(home_url(), $_SERVER['HTTP_HOST'],true) . $_SERVER['HTTP_HOST'].'/static';
...
function validate_current_theme() {
	...
	if ( get_template() != WP_DEFAULT_THEME && !file_exists(get_template_directory() . '/index.php') && !file_exists(get_template_directory() . '/style.css') ) {
